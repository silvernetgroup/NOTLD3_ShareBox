...
namespace AppStudio
{
    ...
    {
        public const string APP_NAME = "ShareBox";
        ...
        {
            TileServices.CreateFlipTile(@"My favourite artist", @"Check this out!", @"DataImages/FlipSquareTile.jpg", "DataImages/FlipWideTile.jpg");
        }
        #endregion
    }
}
